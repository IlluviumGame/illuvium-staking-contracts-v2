...
export const formatEther = (value: BigNumberish) => ethers.utils.formatEther(value);
...
export const getUsers5 = (addresses: string[]) => [
  {
    userAddress: addresses[0],
    deposits: [
      {
  ...
  },
  {
    ...
    deposits: [
      ...
      {
        tokenAmount: toWei(1000),
        weight: toWei(1000).mul(2e6),
        lockedFrom: INIT_TIME,
        lockedUntil: INIT_TIME + ONE_YEAR,
        isYield: true,
      },
...
export const getTestBalanceTree = (alice: SignerWithAddress, bob: SignerWithAddress, carol: SignerWithAddress) => {
